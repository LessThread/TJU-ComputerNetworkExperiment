...
// request_connection: token ows t_colon ows text ows t_crlf {
// 	YPRINTF("request_connection:\n%s\n",$1);
//     //strcpy(parsing_request->http_connection, $1);
// }

// request_accept: token ows t_colon ows text ows t_crlf {
// 	YPRINTF("request_ua:\n%s\n",$1);
//     //strcpy(parsing_request->http_accept, $1);
// }

// request_ua: token ows t_colon ows text ows t_crlf {
// 	YPRINTF("request_ua:\n%s\n",$1);
//     //strcpy(parsing_request->http_ua, $1);
// }

// request_ae: token ows t_colon ows text ows t_crlf {
// 	YPRINTF("request_ae:\n%s\n",$1);
//     //strcpy(parsing_request->http_ae, $1);
// }

// request_al: token ows t_colon ows text ows t_crlf {
// 	YPRINTF("request_al:\n%s\n",$1);
//     //strcpy(parsing_request->http_al, $1);
// };

// request: request_line request_header request_connection request_accept request_ua  request_ae request_al t_crlf{
